...
for vpt in 1 2 3; do
    tag=$currenttime"_bs64_ToMe_"$tome_r"_peft_vpt_"${vpt}
    ...
    for i in ${!corruptions[@]}; do
        ...
        python3 main_navia_peft.py \
            ...
            --tag $tag --vpt ${vpt} > /home/xiongyizhe/CVPR2026/MGTTA/outputs/$algorithm"_"$tag/C/$corruption-running-log.txt
    done
done

for lora in 1 2 3; do
    tag=$currenttime"_bs64_ToMe_"$tome_r"_peft_lora_"${lora}
    ...
    for i in ${!corruptions[@]}; do
        ...
        python3 main_navia_peft.py \
            ...
            --algorithm $algorithm \
            --apply_tome --tome_r $tome_r \
            --tag $tag --lora ${lora} > /home/xiongyizhe/CVPR2026/MGTTA/outputs/$algorithm"_"$tag/C/$corruption-running-log.txt
    done
done