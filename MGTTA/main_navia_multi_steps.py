...
import tta_library.foa_bp_multi_steps as foa_bp
...
def get_args():
    ...
    parser.add_argument('--gradient_steps', default=1, type=int, help='Rebuttal: gradient step numbers.') 
...
if __name__ == '__main__':
    ...
    if args.algorithm == 'tent':
        ...
        adapt_model = foa_bp.FOA_BP(net, optimizer, args.lambda_bp, steps=args.gradient_steps)
        _, train_loader = obtain_train_loader(args)
