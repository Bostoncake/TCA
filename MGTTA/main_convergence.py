...
import tta_library.foa_bp_convergence as foa_bp
            ...
            if args.algorithm == 'tent_bp_gtloss':
                ...
                if args.count_flops:
                    ...
                    if i < args.num_adapt_iters:
                        ...
                        output = model(images, update=False)
            if not pretrain:
...
def get_args():
    ...
    parser.add_argument('--num_adapt_iters', default=25, type=int, help='number of iterations adapted before evaluation')
    parser.add_argument('--start_validation', default=650, type=int, help='index of the iteration that validation starts during convergence analysis')
