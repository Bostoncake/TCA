...
for tome_r in 4 8; do
    ...
    for lr_shift in 0.1 0.05 0.01 0.005 0.001 0.0005 0.0001 0.00005; do

        tag=$currenttime"_bs64_ToMe_"$tome_r"_best_params_for_lr_cls_lr_cls_ssf_and_layer_NOW_learnable_shift_lr_"$lr_shift"_tune_hist"
        ...
        for i in ${!corruptions[@]}; do
            ...
            python3 main.py \
                ...
                --apply_learnable_shift --apply_sep_lr_shift --lr_shift $lr_shift \
