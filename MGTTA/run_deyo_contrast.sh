...
for seed in 2010 2011 2012 2013 2014 2015 2016 2017 2018; do
    echo $corruption
    python3 main.py \
        --batch_size 64 \
        --workers 8 \
        ...
        --tag $tag > /nlp_group/xiongyizhe/research/TTA/MGTTA/outputs/$algorithm"_"$tag/C/$corruption-running-log-$seed.txt
done